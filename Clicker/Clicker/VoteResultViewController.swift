...
//  Clicker
//
//  Created by Likai Wei on 5/26/16.
...
class VoteResultViewController: UIViewController, CBCentralManagerDelegate, CBPeripheralDelegate {
    
    @IBOutlet private var A_Result: UILabel!
    @IBOutlet private var B_Result: UILabel!
    @IBOutlet private var C_Result: UILabel!
    @IBOutlet private var D_Result: UILabel!
    ...
    func peripheral(peripheral: CBPeripheral, didUpdateValueForCharacteristic characteristic: CBCharacteristic, error: NSError?) {
        ...
        if stringFromData.isEqualToString("EOM") {
            ...
            switch (String(data: data.copy() as! NSData, encoding: NSUTF8StringEncoding))! {
            case "A":
                A_count += 1
                print("Receive A")
            case "B":
            ...
            A_Result.text = String(A_count)
            B_Result.text = String(B_count)
            C_Result.text = String(C_count)
            D_Result.text = String(D_count)
